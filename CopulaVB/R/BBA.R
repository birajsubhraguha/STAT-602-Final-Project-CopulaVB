...
# this defines intermediate values for the partial derivatives
del = function(z, mu_mat, std_mat, rho) {
  del_mu_1 =
}
...
## this defines the derivative of the log variational density
